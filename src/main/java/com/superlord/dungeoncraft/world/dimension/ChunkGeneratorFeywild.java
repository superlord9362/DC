package com.superlord.dungeoncraft.world.dimension;
...
public class ChunkGeneratorFeywild implements IChunkGenerator
{
    ...
    public ChunkGeneratorFeywild(World worldIn, long seed)
    {
        this.world = worldIn;
    ...
    private void generateHeightmap(int chunkX, int chunkZ)
    {
        ...
        this.mainNoiseRegion = this.mainPerlinNoise.generateNoiseOctaves(this.mainNoiseRegion, chunkX, 0, chunkZ, 5, 33, 5, 8.555150000000001D, 4.277575000000001D, 8.555150000000001D);
        this.minLimitRegion = this.minLimitPerlinNoise.generateNoiseOctaves(this.minLimitRegion, chunkX, 0, chunkZ, 5, 33, 5, 684.412D, 684.412D, 684.412D);
        this.maxLimitRegion = this.maxLimitPerlinNoise.generateNoiseOctaves(this.maxLimitRegion, chunkX, 0, chunkZ, 5, 33, 5, 684.412D, 684.412D, 684.412D);
        int i = 0;
        int j = 0;
    ...
    public void populate(int x, int z)
    {
        ...
        if (TerrainGen.populate(this, this.world, this.rand, x, z, false, PopulateChunkEvent.Populate.EventType.ANIMALS))
            WorldEntitySpawner.performWorldGenSpawning(this.world, biome, i + 8, j + 8, 16, 16, this.rand);
        blockpos = blockpos.add(8, 0, 8);

        if (TerrainGen.populate(this, this.world, this.rand, x, z, false, PopulateChunkEvent.Populate.EventType.ICE))
        {
