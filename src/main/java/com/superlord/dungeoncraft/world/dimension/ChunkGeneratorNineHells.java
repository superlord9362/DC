...
public class ChunkGeneratorNineHells implements IChunkGenerator

{
    ...
    protected static final IBlockState MAIN_BLOCK = ModBlocks.ASH.getDefaultState();
    ...
    protected static final IBlockState OTHER_BLOCK1 = ModBlocks.ASH.getDefaultState();

    protected static final IBlockState OTHER_BLOCK2 = ModBlocks.ASH.getDefaultState();
    ...
    public ChunkGeneratorNineHells(World world, boolean generate, long seed)
