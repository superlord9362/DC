package com.superlord.dungeoncraft.world.gen.generators;
...
import com.superlord.dungeoncraft.util.Utils;
...
public class WorldGenStructure extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, BlockPos position) {
		...
		Template template = templateManager.get(minecraftServer,
				...
				new ResourceLocation(Reference.MOD_ID, this.structureName));
