...
public class ItemBucket extends Item implements IHasModel
{
    ...
    public ItemBucket(Block containedBlockIn, String name)
    {
        this.maxStackSize = 1;
        this.containedBlock = containedBlockIn;
        this.setCreativeTab(Main.dungeoncraft);
        ...
        else
        {
            ...
            else if (flag)
            {
                ...
                else
                {
                    ...
                    if (material == Material.WATER && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0)
                    {
                        ...
                        return new ActionResult<ItemStack>(EnumActionResult.SUCCESS, this.fillBucket(itemstack, playerIn, ModItems.WOODEN_WATER_BUCKET));
                    }
                    else
                    {
                        return new ActionResult<ItemStack>(EnumActionResult.FAIL, itemstack);
            ...
            else
            {
                ...
                else if (this.tryPlaceContainedLiquid(playerIn, worldIn, blockpos1))
                {
                    ...
                    playerIn.addStat(StatList.getObjectUseStats(this));
                    return !playerIn.capabilities.isCreativeMode ? new ActionResult(EnumActionResult.SUCCESS, new ItemStack(ModItems.WOODEN_BUCKET)) : new ActionResult(EnumActionResult.SUCCESS, itemstack);
                }
                else
                {
                    return new ActionResult<ItemStack>(EnumActionResult.FAIL, itemstack);
