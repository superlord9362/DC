...
public class EntityPony extends AbstractHorse
{
    private static final UUID ARMOR_MODIFIER_UUID = UUID.fromString("556E1665-8B10-40C8-8F9D-CF9B1667F295");
    private static final DataParameter<Integer> HORSE_VARIANT = EntityDataManager.<Integer>createKey(EntityPony.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> HORSE_ARMOR = EntityDataManager.<Integer>createKey(EntityPony.class, DataSerializers.VARINT);
    ...
    {
        AbstractHorse.registerFixesAbstractHorse(fixer, EntityPony.class);
        fixer.registerWalker(FixTypes.ENTITY, new ItemStackData(EntityPony.class, new String[] {"ArmorItem"}));
    }
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityDonkey) && !(otherAnimal instanceof EntityPony))
        {
            return false;
        }
        else
    ...
    public EntityAgeable createChild(EntityAgeable ageable)
    {
        ...
        {
            EntityPony entityhorse = (EntityPony)ageable;
            abstracthorse = new EntityPony(this.world);
            ...
            ((EntityPony)abstracthorse).setHorseVariant(i);
        }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        if (livingdata instanceof EntityPony.GroupData)
        {
            i = ((EntityPony.GroupData)livingdata).variant;
        }
        else
        {
            i = this.rand.nextInt(7);
            livingdata = new EntityPony.GroupData(i);
        }
