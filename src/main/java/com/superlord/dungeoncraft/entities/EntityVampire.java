...
public class EntityVampire extends EntityMob
{
     ...
     */
    private static final DataParameter<Integer> VILLAGER_TYPE = EntityDataManager.<Integer>createKey(EntityVampire.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> ARMS_RAISED = EntityDataManager.<Boolean>createKey(EntityVampire.class, DataSerializers.BOOLEAN);
    ...
    protected void applyEntityAI()
    {
        ...
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityGuardV.class, true));
    }
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(144.0D);
    }
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityVampire.class);
    }
    ...
    public void onKillEntity(EntityLivingBase entityLivingIn)
    {
        ...
        if ((this.world.getDifficulty() == EnumDifficulty.NORMAL || this.world.getDifficulty() == EnumDifficulty.HARD) && entityLivingIn instanceof EntityVillager)
        {
            ...
            EntityVampireSpawn entityzombievillager = new EntityVampireSpawn(this.world);
            entityzombievillager.copyLocationAndAnglesFrom(entityvillager);
            this.world.removeEntity(entityvillager);
            entityzombievillager.onInitialSpawn(this.world.getDifficultyForLocation(new BlockPos(entityzombievillager)), new EntityVampire.GroupData(false));
        ...
        if ((this.world.getDifficulty() == EnumDifficulty.NORMAL || this.world.getDifficulty() == EnumDifficulty.HARD) && entityLivingIn instanceof EntityGuardV)
        {

            EntityGuardV entityvillager = (EntityGuardV)entityLivingIn;
            EntityVampireSpawn entityzombievillager = new EntityVampireSpawn(this.world);
            entityzombievillager.copyLocationAndAnglesFrom(entityvillager);
            this.world.removeEntity(entityvillager);
            entityzombievillager.onInitialSpawn(this.world.getDifficultyForLocation(new BlockPos(entityzombievillager)), new EntityVampire.GroupData(false));
        ...
        if ((this.world.getDifficulty() == EnumDifficulty.NORMAL || this.world.getDifficulty() == EnumDifficulty.HARD) && entityLivingIn instanceof EntityPlayer)
        {

        	EntityPlayer entityvillager = (EntityPlayer)entityLivingIn;
            EntityVampireSpawn entityzombievillager = new EntityVampireSpawn(this.world);
            entityzombievillager.copyLocationAndAnglesFrom(entityvillager);
            entityzombievillager.onInitialSpawn(this.world.getDifficultyForLocation(new BlockPos(entityzombievillager)), new EntityVampire.GroupData(false));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        if (livingdata == null)
        {
            livingdata = new EntityVampire.GroupData(this.world.rand.nextFloat() < net.minecraftforge.common.ForgeModContainer.zombieBabyChance);
        }

        if (livingdata instanceof EntityVampire.GroupData)
        {
            EntityVampire.GroupData entityzombie$groupdata = (EntityVampire.GroupData)livingdata;
