...
public class EntityDwarf extends EntityMob
{
    ...
    public EntityDwarf(World worldIn) {
     ...
     protected void initEntityAI()
        ...
        protected void applyEntityAI()
        {
            ...
            this.targetTasks.addTask(1, new EntityDwarf.AIHurtByAggressor(this));
            this.targetTasks.addTask(2, new EntityDwarf.AITargetAggressor(this));

        }
        
        static class AIHurtByAggressor extends EntityAIHurtByTarget
        {
            public AIHurtByAggressor(EntityDwarf p_i45828_1_)
            {
            ...
            protected void setEntityAttackTarget(EntityCreature creatureIn, EntityLivingBase entityLivingBaseIn)
            {
                ...
                if (creatureIn instanceof EntityDwarf)
                {
                    ((EntityDwarf)creatureIn).becomeAngryAt(entityLivingBaseIn);
                }
            }
        }
    ...
    static class AITargetAggressor extends EntityAINearestAttackableTarget<EntityPlayer>
        {
            public AITargetAggressor(EntityDwarf p_i45829_1_)
            {
            ...
            {
                return ((EntityDwarf)this.taskOwner).isAngry() && super.shouldExecute();
            }
        }
