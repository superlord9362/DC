...
public class RenderYuanTi extends RenderLiving<EntityYuanTi> {

	public static final Factory FACTORY = new Factory();

	public RenderYuanTi(RenderManager manager) {
		super(manager, new ModelYuanTi(), 0.2F);
	}

	@Override
	protected ResourceLocation getEntityTexture(EntityYuanTi entity) {
		return new ResourceLocation(Reference.MOD_ID, "textures/entities/yuanti.png");
	}

	public static class Factory implements IRenderFactory<EntityYuanTi> {
        @Override
        public Render<? super EntityYuanTi> createRenderFor(RenderManager manager) {
            return new RenderYuanTi(manager);
        }
    }
}