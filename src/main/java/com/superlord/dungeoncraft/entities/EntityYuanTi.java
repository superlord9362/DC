...
public class EntityYuanTi extends EntityMob
{

    public EntityYuanTi(World worldIn) {
        super(worldIn);
     ...
     protected void initEntityAI()
        ...
        protected void applyEntityAttributes()
        {
            ...
            this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(127.0D);
        }
        
        protected SoundEvent getAmbientSound()
        {
            return SoundsHandler.KOBOLD_IDLE;
        }

        protected SoundEvent getHurtSound(DamageSource p_184601_1_)
        {
            return SoundsHandler.KOBOLD_HURT;
        }

        protected SoundEvent getDeathSound()
        {
            return SoundsHandler.KOBOLD_DEATH;
        }
